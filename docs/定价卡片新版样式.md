...
官网定价卡片样式调整；
下面我依次提供新版本的定价卡片的样式代码，分别是HTML、CSS、js。请根据这些样式将我们定价页面的卡片进行更换未接新的样式风格，但是功能不受影响。

```html
<body class="bg-white dark:bg-black font-normal">
  <!-- LIGHT DARK TOGGLE BTN START -->
  <div class="fixed top-[12%] translate-y-[-12%] right-0 z-50">
    <button
      class="bg-light dark:bg-dark w-[50px] h-[50px] text-white flex justify-center items-center rounded-l-lg"
      id="light__to--dark"
    >
    ...
    <div class="container">
      ...
      <div class="text-center max-w-3xl mx-auto mb-10">
        ...
        <p class="mt-4 text-gray-600 dark:text-gray-300 md:text-lg">
          Choose from Our Flexible Plans for a Personalized Journey. Embrace a Spectrum of
          Opportunities to Elevate Your Path to Success.
        </p>
      </div>
      <!-- TITLE END -->
      ...
      <ul class="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
        ...
        <li class="contents">
          ...
          >
            ...
            <div class="my-8 flex items-center">
              <span class="mr-2 text-5xl font-extrabold text-light dark:text-dark"> $99 </span>
              <span>/month</span>
            </div>
            ...
            <a
              href="#"
              class="text-xl dark:text-white text-light font-semibold rounded-lg px-5 py-3 text-center border-2 border-light dark:border-dark mt-auto hover:bg-light dark:hover:bg-dark hover:text-white transition-all duration-500"
            >
              Get started
            </a>
          </div>
        ...
        <li class="contents">
          ...
          >
            ...
            <!-- ITEM PRICE -->
            <div class="my-8 flex items-center">
              <span class="mr-2 text-5xl font-extrabold text-light dark:text-dark"> $199 </span>
              <span>/month</span>
            </div>
            ...
            <a
              href="#"
              class="text-xl bg-light dark:bg-dark dark:text-white text-white font-semibold rounded-lg px-5 py-3 text-center border border-light dark:border-dark mt-auto hover:bg-light dark:hover:bg-dark hover:text-white transition-all duration-500"
            >
              Get started
            </a>
          </div>
        ...
        <li class="contents">
          ...
          >
            ...
            <!-- ITEM PRICE -->
            <div class="my-8 flex items-center">
              <span class="mr-2 text-5xl font-extrabold text-light dark:text-dark"> $499 </span>
              <span>/month</span>
            </div>
            <!-- FEATURE LIST List -->
            <ul class="mb-8 space-y-4 text-left">
