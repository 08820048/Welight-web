      ...
      <nav class="hidden lg:flex items-center justify-between h-16">
        ...
        <div class="flex items-center gap-1">
            ...
            <div class="relative group">
              ...
              <!-- Dropdown Menu -->
              <div class="absolute top-full left-0 mt-2 w-64 bg-white rounded-2xl shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[60]">
                <div class="p-3">
                  <a href="https://qm.qq.com/q/nNA64h5d6K" target="_blank"
                    ...
                    <svg class="w-5 h-5 text-gray-600 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button 
              ...
              公告
              <div v-if="hasNewAnnouncements" class="absolute top-1.5 right-1.5 w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>
            </button>
        ...
        <div class="flex items-center gap-2">
          <!-- 活动菜单项 -->
          <button
            v-for="promo in menuPromotions"
            :key="promo.id"
            @click="showPromotionBanner(promo)"
          ...
          <router-link
            to="/download"
            class="inline-flex h-9 items-center justify-center rounded-full px-4 py-2 text-sm font-medium border border-gray-300 bg-white text-gray-900 transition-colors hover:bg-gray-50">
            前往下载
          </router-link>

          <router-link
            to="/documentation"
            @click="markDocsUpdateViewed"
            class="relative inline-flex h-9 items-center justify-center rounded-full px-4 py-2 text-sm font-medium bg-gray-900 text-white transition-colors hover:bg-gray-800">
            阅读文档
      ...
      <div
        ...
        <div class="p-6">
          ...
          <nav class="space-y-1">
            ...
            <button
              @click="showAnnouncements(); closeMobileMenu()"
            ...
            <button
              @click="showChangelog(); closeMobileMenu()"
            ...
            <div class="border-t border-gray-200 pt-4 mt-4">
              ...
              <a href="https://docs.qq.com/sheet/DS1RITFdUR1BQSURY?tdsourcetag=nt-grpaio-file" target="_blank" @click="closeMobileMenu"
                class="block px-4 py-3 text-sm font-medium text-gray-700 rounded-xl hover:bg-gray-100 transition-colors">
                问题反馈
              </a>
              <a href="https://docs.qq.com/sheet/DS3NVaFhQeVZTSG11?tdsourcetag=nt-grpaio-file" target="_blank" @click="closeMobileMenu"
                class="block px-4 py-3 text-sm font-medium text-gray-700 rounded-xl hover:bg-gray-100 transition-colors">
                功能诉求
              </a>
            </div>
          ...
          <div class="mt-6 space-y-3 border-t border-gray-200 pt-6">
            ...
            <router-link
              to="/documentation"
              @click="markDocsUpdateViewed(); closeMobileMenu()"
