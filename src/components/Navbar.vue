<template>
  <nav class="fixed top-0 left-0 right-0 z-50">
      ...
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center space-x-2">
          ...
          <div class="hidden md:flex items-center space-x-2">
            <div class="flex items-center space-x-2 px-3 py-2 text-gray-400 cursor-not-allowed rounded-lg relative"
              title="文档建设中，敬请期待">
              ...
              <!-- 建设中上标 -->
              <sup
                class="absolute -top-1 -right-1 bg-orange-500 text-white text-xs px-1.5 py-0.5 rounded-full font-medium">
                建设中
              </sup>
            </div>
          </div>
          ...
          <div class="relative group">
            ...
            <!-- 下拉菜单 -->
            <div
              class="absolute top-full right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <div class="py-2">
          ...
          <router-link to="/monthly-cards"
            ...
            <span class="hidden sm:inline text-sm font-medium">月卡管理</span>
          </router-link>
    ...
    <!-- 技术服务模态框 -->
    <div v-if="isTechSupportVisible"
      class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" @click="closeTechSupport">
      <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 modal-content" @click.stop>
        <div class="p-6">
                ...
                <div>
                  ...
                  <ul class="space-y-1 text-sm">
                    ...
                    <li class="flex items-center space-x-2">
                      ...
                      <span>AI模型配置与调试（DeepSeek、Ollama等）</span>
                    </li>
                    <li class="flex items-center space-x-2">
                      <svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
          ...
          <div class="flex space-x-3 mt-6">
            <button @click="closeTechSupport"
              class="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
              关闭
            </button>
            <a href="tencent://AddContact/?fromId=45&fromSubId=1&subcmd=all&uin=2217021563&website=www.oicqzone.com"
