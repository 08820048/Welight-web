<template>
  <div class="grid [grid-template-areas:'stack'] opacity-100 animate-in fade-in-0 duration-700" :class="centered ? 'place-items-center' : ''">
    ...
    <div
      ...
      :style="{ transform: card3Hover ? 'rotateX(4deg) rotateY(-2deg) rotateZ(-5deg) translateX(2rem) translateY(1rem)' : 'rotateX(4deg) rotateY(-2deg) rotateZ(-5deg) translateX(2rem) translateY(1.5rem)' }">
      <div class="relative rounded-2xl overflow-hidden shadow-lg ring-1 ring-gray-200">
    ...
    <div
      ...
      :style="{ transform: card2Hover ? 'rotateX(4deg) rotateY(-2deg) rotateZ(-5deg) translateX(4rem) translateY(2.5rem)' : 'rotateX(4deg) rotateY(-2deg) rotateZ(-5deg) translateX(4rem) translateY(3rem)' }">
      <div class="relative rounded-2xl overflow-hidden shadow-lg ring-1 ring-gray-200">
