<template>
  <div class="grid [grid-template-areas:'stack'] opacity-100 animate-in fade-in-0 duration-700" :class="centered ? 'place-items-center' : ''">
    ...
    <div
      ...
      <div class="relative z-10 rounded-2xl overflow-hidden shadow-lg ring-1 ring-gray-200">
    ...
    <!-- Card 2 - Front -->
    <div
      :class="['relative w-full select-none rounded-2xl border-2 border-gray-200 bg-white backdrop-blur-sm p-4 transition-all duration-700 [grid-area:stack] z-20 after:absolute after:-right-2 after:top-0 after:h-[100%] after:w-full after:bg-gradient-to-l after:from-white after:to-transparent after:content-[\'\'] after:z-0', maxWidthClass]"
