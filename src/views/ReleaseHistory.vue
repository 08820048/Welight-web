<template>
  <div class="min-h-screen text-gray-200 pt-20 relative overflow-hidden bg-gray-50 dark:bg-gray-900">
    <!-- Hero Section -->
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <div class="flex items-center mb-3">
                    <svg class="w-5 h-5 text-blue-600 dark:text-blue-400 mr-2" viewBox="0 0 24 24" fill="currentColor">
                      <path
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <div class="flex items-center mb-3">
                    <svg class="w-5 h-5 text-gray-600 dark:text-gray-300 mr-2" viewBox="0 0 24 24" fill="currentColor">
                      <path
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <div class="flex items-center mb-3">
                    <svg class="w-5 h-5 text-orange-600 dark:text-orange-400 mr-2" viewBox="0 0 24 24" fill="currentColor">
                      <path
