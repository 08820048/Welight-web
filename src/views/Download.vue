    ...
    <section class="section-padding bg-white dark:bg-gray-900">
      <div class="container-custom">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <!-- macOS -->
          <div class="card p-8 text-center hover:scale-105 transition-transform duration-300">
            <div class="w-16 h-16 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center mx-auto mb-6">
          ...
          <!-- Linux -->
          <div class="card p-8 text-center hover:scale-105 transition-transform duration-300">
            <div class="w-16 h-16 bg-orange-100 dark:bg-orange-900 rounded-lg flex items-center justify-center mx-auto mb-6">
...
const downloadFile = async (platform) => {
  ...
  const downloadUrls = {
    // Windows
    'windows-installer': 'https://waer.ltd/downloads/windows/Welight_2.3.2_x64-setup.exe',
    'windows-msi': 'https://waer.ltd/downloads/windows/Welight_2.3.2_x64_en-US.msi',
    // macOS
    'macos-apple': 'https://waer.ltd/downloads/mac/Welight_2.3.2_aarch64.dmg',
    'macos-intel': 'https://waer.ltd/downloads/mac/Welight_2.3.2_x64.dmg',
    // Linux
    'linux-appimage': 'https://waer.ltd/downloads/linux/Welight_2.3.2_amd64.AppImage',
    'linux-deb': 'https://waer.ltd/downloads/linux/Welight_2.3.2_amd64.deb',
    'linux-rpm': 'https://waer.ltd/downloads/linux/Welight-2.3.2-1.x86_64.rpm'
  }
