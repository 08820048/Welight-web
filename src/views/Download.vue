        ...
        <div class="container-custom relative">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div class="card p-8 text-center hover:scale-105 transition-transform duration-300">
              <div
                class="w-16 h-16 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center mx-auto mb-6">
                <svg class="w-8 h-8 text-gray-900 dark:text-gray-200" viewBox="0 0 24 24" fill="currentColor">
                  <path
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md mx-4 shadow-2xl" @click.stop>
              <div class="text-center">
                ...
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-6">
                  ...
                  <p v-if="copied" class="text-gray-900 dark:text-gray-200 text-sm mt-2">群号已复制到剪贴板</p>
                </div>
        ...
        <div class="container-custom relative">
          <div class="text-center">
            <AnimatedUnderlineText text="帮助我们改进 Welight"
              ...
              underline-className="text-gray-900 dark:text-white" />
            <MagicText text="您的反馈对我们非常重要，让我们一起打造更好的产品" container-className="mt-4 mb-8 justify-center"
              word-className="text-lg text-gray-600 dark:text-gray-300" />
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md mx-auto">
              <a href="https://docs.qq.com/sheet/DS1RITFdUR1BQSURY?tdsourcetag=nt-grpaio-file" target="_blank"
                class="w-full sm:w-auto inline-flex items-center justify-center space-x-2 px-6 py-3 bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition-colors duration-200 font-medium">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
const downloadFile = async (platform) => {
  ...
  const downloadUrls = {
    // Windows
    'windows-installer': 'https://waer.ltd/downloads/windows/Welight_4.1.2_x64-setup.exe',
    'windows-msi': 'https://waer.ltd/downloads/windows/Welight_4.1.2_x64_en-US.msi',
    // macOS 下载链接
    'macos-apple': 'https://waer.ltd/downloads/mac/Welight_4.1.2_aarch64.dmg',
    'macos-intel': 'https://waer.ltd/downloads/mac/Welight_4.1.2_x64.dmg',
    // Linux 下载链接
    'linux-appimage': 'https://waer.ltd/downloads/linux/Welight_4.1.2_amd64.AppImage',
    'linux-deb': 'https://waer.ltd/downloads/linux/Welight_4.1.2_amd64.deb',
    'linux-rpm': 'https://waer.ltd/downloads/linux/Welight-4.1.2-1.x86_64.rpm'
  }
