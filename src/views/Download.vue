...
const downloadFile = async (platform) => {
  ...
  const downloadUrls = {
    // Windows
    'windows-installer': 'https://waer.ltd/downloads/windows/Welight_2.3.1_x64-setup.exe',
    'windows-msi': 'https://waer.ltd/downloads/windows/Welight_2.3.1_x64_en-US.msi',
    // macOS
    'macos-apple': 'https://waer.ltd/downloads/mac/Welight_2.3.1_aarch64.dmg',
    'macos-intel': 'https://waer.ltd/downloads/mac/Welight_2.3.1_x64.dmg',
    // Linux
    'linux-appimage': 'https://waer.ltd/downloads/linux/Welight_2.3.1_amd64.AppImage',
    'linux-deb': 'https://waer.ltd/downloads/linux/Welight_2.3.1_amd64.deb',
    'linux-rpm': 'https://waer.ltd/downloads/linux/Welight-2.3.1-1.x86_64.rpm'
  }
