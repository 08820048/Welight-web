      ...
      <div class="container-custom">
        ...
        <div class="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
          ...
          <div class="mb-12">
            ...
            <div
              class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-6">
            ...
            <div class="space-y-6">
              ...
              <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                ...
                <div
                  class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded p-3">
