<template>
  <div class="product-main min-h-screen">
    <section class="px-4 pt-24 md:px-6 md:pt-28">
            ...
            <div class="grid gap-5 md:grid-cols-[220px_1fr] md:gap-10 lg:grid-cols-[260px_1fr]">
              ...
              <div>
                ...
                <div class="mt-6 grid gap-6 md:grid-cols-2">
                  <div>
                    <p class="text-sm font-semibold text-[#1B365D] dark:text-[#D0DCE9]">QQ 交流群</p>
                  ...
                  <div>
                    <p class="text-sm font-semibold text-[#1B365D] dark:text-[#D0DCE9]">微信交流群</p>
                    <div class="mt-3 max-w-[180px]">
                      <img
...
useSEO({
  title: '致谢 - Welight',
  description: 'Welight 感谢开源社区和第三方服务的支持。',
