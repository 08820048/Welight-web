              ...
              <div class="relative transform transition-all duration-700 group perspective-1000">
                ...
                <div
                  ...
                  <div class="relative overflow-hidden rounded-2xl">
                    <img src="https://images.waer.ltd/notes/202509052129898.png" alt="Welight 主题预览界面"
            ...
            <div class="relative">
              ...
              <div class="relative transform hover:scale-105 transition-all duration-700 group">
                <div
                  ...
                  <!-- Main screenshot -->
                  <div class="relative overflow-hidden rounded-2xl">
                    <img src="https://images.waer.ltd/notes/202508301851082.png" alt="Welight 核心特性展示"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div class="group scroll-animate scale-up" style="transition-delay: 0.4s;">
            <div
              ...
              <div class="aspect-[4/3] overflow-hidden">
                <img src="https://images.waer.ltd/notes/202509082113229.png" alt="纸质纹理主题"
          ...
          <div class="group scroll-animate scale-up" style="transition-delay: 0.5s;">
            <div
              ...
              <!-- Theme preview image -->
              <div class="aspect-[4/3] overflow-hidden">
                <img src="https://images.waer.ltd/notes/202509082114921.png" alt="森林物语主题"
                  class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700"
                  loading="lazy" />
              </div>
              <!-- Theme info -->
          ...
          <div class="group scroll-animate scale-up" style="transition-delay: 0.6s;">
            <div
              class="relative overflow-hidden rounded-2xl bg-pink-50 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              <!-- Theme preview image -->
              <div class="aspect-[4/3] overflow-hidden">
                <img src="https://images.waer.ltd/notes/202509082114104.png" alt="粉色佳人主题"
                  class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700"
                  loading="lazy" />
              </div>
              <!-- Theme info -->
              ...
              <!-- Hover overlay -->
              <div
                class="absolute inset-0 bg-gradient-to-t from-pink-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              </div>
            </div>
          </div>
          ...
          <div class="group scroll-animate scale-up" style="transition-delay: 0.7s;">
            <div
              ...
              <!-- Theme preview image -->
              <div class="aspect-[4/3] overflow-hidden">
                <img src="https://images.waer.ltd/notes/202509082115670.png" alt="水墨丹青主题"
                  class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700"
                  loading="lazy" />
              </div>
              <!-- Theme info -->
          ...
          <div class="group scroll-animate scale-up" style="transition-delay: 0.8s;">
            <div
              class="relative overflow-hidden rounded-2xl bg-blue-50 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              <!-- Theme preview image -->
              <div class="aspect-[4/3] overflow-hidden">
                <img src="https://images.waer.ltd/notes/202509082116125.png" alt="科技蓝调主题"
                  class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700"
                  loading="lazy" />
              </div>
              <!-- Theme info -->
              ...
              <!-- Hover overlay -->
              <div
                class="absolute inset-0 bg-gradient-to-t from-blue-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              </div>
            </div>
          </div>
          ...
          <div class="group scroll-animate scale-up" style="transition-delay: 0.9s;">
            <div
              class="relative overflow-hidden rounded-2xl bg-red-50 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              <!-- Theme preview image -->
              <div class="aspect-[4/3] overflow-hidden">
                <img src="https://images.waer.ltd/notes/202509082117612.png" alt="建国大业主题"
                  class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700"
                  loading="lazy" />
              </div>
              <!-- Theme info -->
              ...
              <!-- Hover overlay -->
              <div
                class="absolute inset-0 bg-gradient-to-t from-red-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center mt-20">
          ...
          <div class="space-y-8">
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-start space-x-4 scroll-animate fade-left" style="transition-delay: 1.5s;">
                <div
                  class="w-12 h-12 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <div class="flex items-start space-x-4 scroll-animate fade-left" style="transition-delay: 1.6s;">
                <div
                  class="w-12 h-12 bg-gradient-to-br from-pink-500 to-pink-600 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="flex items-start space-x-4 scroll-animate fade-left" style="transition-delay: 1.7s;">
                <div
                  class="w-12 h-12 bg-gradient-to-br from-teal-500 to-teal-600 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <div class="scroll-animate fade-right" style="transition-delay: 1.8s;">
            <div class="relative">
              <!-- Background glow -->
              <div
                class="absolute inset-0 bg-gradient-to-br from-indigo-200/20 via-purple-200/10 to-pink-200/20 rounded-3xl blur-3xl">
              </div>
              ...
              <div class="relative transform hover:scale-105 transition-all duration-700 group">
                <div
                  ...
                  <!-- Enhanced shadows -->
                  <div
                    class="absolute -inset-4 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 rounded-3xl blur-xl -z-10">
                  </div>
                  <div
                    class="absolute -inset-8 bg-gradient-to-br from-purple-500/5 to-pink-500/5 rounded-3xl blur-2xl -z-20">
                  </div>
                </div>

                <!-- Floating AI indicator -->
                <div
                  class="absolute -top-4 -left-4 w-16 h-16 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-full flex items-center justify-center shadow-lg animate-pulse">
                  <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
