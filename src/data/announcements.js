...
近期，使用的构建服务（GitHub Actions）的免费额度已用尽，继续使用将带来较高的费用。作为一个业余的独立开发者，应用本身是完全免费的，但是更新迭代需要的构建费用确实是一笔不小的开销，然而，应用内开启的 **捐赠**功能，至今没有收到一分钱的捐赠，这让我想起网络上那个"免费助人被骂廉价傻逼的段子。"，因此后续会大幅降低更新频率，感谢 B 站网友和其他用户的支持和理解。

![GitHub Actions 费用截图](https://images.waer.ltd/notes/202509152208460.png)

![捐赠功能截图](https://images.waer.ltd/notes/202509152208325.png)
